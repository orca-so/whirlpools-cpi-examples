...
export declare function getInitializeConfidentialTransferFeeDiscriminatorBytes(): import("@solana/web3.js").ReadonlyUint8Array;
export declare const INITIALIZE_CONFIDENTIAL_TRANSFER_FEE_CONFIDENTIAL_TRANSFER_FEE_DISCRIMINATOR = 0;
export declare function getInitializeConfidentialTransferFeeConfidentialTransferFeeDiscriminatorBytes(): import("@solana/web3.js").ReadonlyUint8Array;
