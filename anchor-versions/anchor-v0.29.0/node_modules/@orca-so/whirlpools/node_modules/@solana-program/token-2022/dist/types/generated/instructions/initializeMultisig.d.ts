...
export declare function getInitializeMultisigInstruction<TAccountMultisig extends string, TAccountRent extends string, TProgramAddress extends Address = typeof TOKEN_2022_PROGRAM_ADDRESS>(input: InitializeMultisigInput<TAccountMultisig, TAccountRent>, config?: {
    programAddress?: TProgramAddress;
}): InitializeMultisigInstruction<TProgramAddress, TAccountMultisig, TAccountRent>;
export type ParsedInitializeMultisigInstruction<TProgram extends string = typeof TOKEN_2022_PROGRAM_ADDRESS, TAccountMetas extends readonly IAccountMeta[] = readonly IAccountMeta[]> = {
