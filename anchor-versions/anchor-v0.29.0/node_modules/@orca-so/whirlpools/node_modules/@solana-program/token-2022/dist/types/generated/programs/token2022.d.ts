...
export declare enum Token2022Instruction {
    ...
    InitializeTokenMetadata = 73,
    UpdateTokenMetadataField = 74,
    RemoveTokenMetadataKey = 75,
    UpdateTokenMetadataUpdateAuthority = 76,
    EmitTokenMetadata = 77,
    InitializeTokenGroup = 78,
    UpdateTokenGroupMaxSize = 79,
    UpdateTokenGroupUpdateAuthority = 80,
    InitializeTokenGroupMember = 81
}
