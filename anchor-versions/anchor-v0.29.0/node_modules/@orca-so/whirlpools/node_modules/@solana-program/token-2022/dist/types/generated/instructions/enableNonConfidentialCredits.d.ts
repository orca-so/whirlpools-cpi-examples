...
export declare function getEnableNonConfidentialCreditsDiscriminatorBytes(): import("@solana/web3.js").ReadonlyUint8Array;
export declare const ENABLE_NON_CONFIDENTIAL_CREDITS_CONFIDENTIAL_TRANSFER_DISCRIMINATOR = 11;
export declare function getEnableNonConfidentialCreditsConfidentialTransferDiscriminatorBytes(): import("@solana/web3.js").ReadonlyUint8Array;
...
export declare function getEnableNonConfidentialCreditsInstructionDataEncoder(): Encoder<EnableNonConfidentialCreditsInstructionDataArgs>;
export declare function getEnableNonConfidentialCreditsInstructionDataDecoder(): Decoder<EnableNonConfidentialCreditsInstructionData>;
export declare function getEnableNonConfidentialCreditsInstructionDataCodec(): Codec<EnableNonConfidentialCreditsInstructionDataArgs, EnableNonConfidentialCreditsInstructionData>;
...
}): EnableNonConfidentialCreditsInstruction<TProgramAddress, TAccountToken, (typeof input)['authority'] extends TransactionSigner<TAccountAuthority> ? ReadonlySignerAccount<TAccountAuthority> & IAccountSignerMeta<TAccountAuthority> : TAccountAuthority>;
export type ParsedEnableNonConfidentialCreditsInstruction<TProgram extends string = typeof TOKEN_2022_PROGRAM_ADDRESS, TAccountMetas extends readonly IAccountMeta[] = readonly IAccountMeta[]> = {
