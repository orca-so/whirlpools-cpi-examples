...
export declare function getTransferCheckedWithFeeDiscriminatorBytes(): import("@solana/web3.js").ReadonlyUint8Array;
export declare const TRANSFER_CHECKED_WITH_FEE_TRANSFER_FEE_DISCRIMINATOR = 1;
export declare function getTransferCheckedWithFeeTransferFeeDiscriminatorBytes(): import("@solana/web3.js").ReadonlyUint8Array;
