...
export declare function getInitializeConfidentialTransferMintDiscriminatorBytes(): import("@solana/web3.js").ReadonlyUint8Array;
export declare const INITIALIZE_CONFIDENTIAL_TRANSFER_MINT_CONFIDENTIAL_TRANSFER_DISCRIMINATOR = 0;
export declare function getInitializeConfidentialTransferMintConfidentialTransferDiscriminatorBytes(): import("@solana/web3.js").ReadonlyUint8Array;
