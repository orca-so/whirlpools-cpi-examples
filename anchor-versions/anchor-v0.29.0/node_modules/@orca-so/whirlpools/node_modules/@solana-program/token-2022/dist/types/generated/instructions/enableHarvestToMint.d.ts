...
export declare function getEnableHarvestToMintDiscriminatorBytes(): import("@solana/web3.js").ReadonlyUint8Array;
export declare const ENABLE_HARVEST_TO_MINT_CONFIDENTIAL_TRANSFER_FEE_DISCRIMINATOR = 4;
export declare function getEnableHarvestToMintConfidentialTransferFeeDiscriminatorBytes(): import("@solana/web3.js").ReadonlyUint8Array;
