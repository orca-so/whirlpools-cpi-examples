...
export declare function getUpdateDefaultAccountStateDiscriminatorBytes(): import("@solana/web3.js").ReadonlyUint8Array;
export declare const UPDATE_DEFAULT_ACCOUNT_STATE_DEFAULT_ACCOUNT_STATE_DISCRIMINATOR = 1;
export declare function getUpdateDefaultAccountStateDefaultAccountStateDiscriminatorBytes(): import("@solana/web3.js").ReadonlyUint8Array;
