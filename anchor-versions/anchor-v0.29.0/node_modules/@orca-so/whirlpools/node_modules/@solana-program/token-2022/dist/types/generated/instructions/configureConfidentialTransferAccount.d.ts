...
export declare function getConfigureConfidentialTransferAccountDiscriminatorBytes(): import("@solana/web3.js").ReadonlyUint8Array;
export declare const CONFIGURE_CONFIDENTIAL_TRANSFER_ACCOUNT_CONFIDENTIAL_TRANSFER_DISCRIMINATOR = 2;
export declare function getConfigureConfidentialTransferAccountConfidentialTransferDiscriminatorBytes(): import("@solana/web3.js").ReadonlyUint8Array;
